...
const API_KEY='aaf6b7c1e3c04d1fcfd7136ce919199c';
...
setInterval(()=>{
    ...
    timeE1.innerHTML=(hourIN12HrsFormat < 10? `0`+hourIN12HrsFormat:hourIN12HrsFormat) + ':' +(minutes < 10 ? `0`+minutes:minutes)+ ' '+ `<span
    id="am-pm">${ampm}</span>`
